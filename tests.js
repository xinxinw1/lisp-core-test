...
test('L.typ(L.lis(L.nu("1"), L.nu("2"), L.nu("3")))', "lis");
...
test('L.has(L.tfn(L.st("test")), L.lis(L.st("tes"), L.st("test"), L.sy("test")))', false, $.isn);
test('L.has(L.tfn(L.jn(function (a){return L.chkb(a > 3);})), L.lis(1, 2, 3))', false);
test('L.has(L.tfn(L.jn(function (a){return L.chkb(a > 3);})), L.lis(2, 3, 4))', false, $.isn);
...
test('L.has(L.nu("1"), L.lis(L.nu("1"), L.nu("1"), L.sy("t")))', false, $.isn);
...
test('L.has(L.nu("1"), L.arr(L.nu("1"), L.nu("1"), L.sy("t")))', false, $.isn);

test('L.has(L.nu("1"), L.st("325"))', false);
test('L.has(L.nu("1"), L.st("321"))', false, $.isn);
test('L.has(L.nu("1"), L.st("123"))', false, $.isn);
test('L.has(L.nu("1"), L.st("12t"))', false, $.isn);
test('L.has(L.nu("1"), L.st("11t"))', false, $.isn);
...
test('L.typ(L.car(L.gres(L.prs1("[a b c]"))))', "sym");
test('L.dat(L.car(L.gres(L.prs1("[a b c]"))))', "fn1");
test('L.typ(L.car(L.gres(L.prs1("{a b c}"))))', "sym");
